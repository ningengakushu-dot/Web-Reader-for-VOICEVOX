...
// 小～中規模のキャプチャは選択範囲全体を比較できるが、全画面級を縦横2モデルへ
// 同時投入すると低コア端末のCPU・メモリを圧迫する。上限を超える場合は従来同様、
// 文字密度が高い小領域だけで確認し、全画像認識を二重化しない。
const OCR_ORIENTATION_FULL_COMPARE_MAX_AREA = 400000;
